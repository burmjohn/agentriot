...
import { assignPromptTaxonomy } from "@/lib/ingestion/prompt-taxonomy-assignment";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const result = await assignPromptTaxonomy({
    ...
    const message =
      error instanceof Error ? error.message : "Unable to assign prompt taxonomy.";
    const status =
