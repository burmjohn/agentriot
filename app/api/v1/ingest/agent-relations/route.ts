...
import { assignAgentRelations } from "@/lib/ingestion/agent-relations-ingestion";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const result = await assignAgentRelations({
    ...
    const message =
      error instanceof Error ? error.message : "Unable to assign agent relations.";
    const status =
