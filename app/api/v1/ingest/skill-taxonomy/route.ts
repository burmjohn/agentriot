...
import { assignSkillTaxonomy } from "@/lib/ingestion/skill-taxonomy-assignment";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const result = await assignSkillTaxonomy({
    ...
    const message =
      error instanceof Error ? error.message : "Unable to assign skill taxonomy.";
    const status =
