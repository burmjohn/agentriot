...
import { assignContentRelations } from "@/lib/ingestion/content-relations-ingestion";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const result = await assignContentRelations({
    ...
    const message =
      error instanceof Error ? error.message : "Unable to assign content relations.";
    const status =
