...
export async function getHomepageSnapshot() {
  ...
  const recentUpdates: HomeRecentUpdate[] = [
    ...articles.map((item) => ({
      ...
      note: item.excerpt ?? item.subtype ?? "article update",
    ...
    ...tutorials.map((item) => ({
      ...
      note: item.excerpt ?? item.subtype ?? "tutorial update",
      updatedAt: item.updatedAt,
    })),
    ...agentsList.map((item) => ({
      ...
      note: item.shortDescription ?? "agent record updated",
      updatedAt: item.updatedAt,
    })),
    ...promptsList.map((item) => ({
      ...
      note: item.shortDescription ?? "prompt updated",
      updatedAt: item.updatedAt,
    })),
    ...skillsList.map((item) => ({
      ...
      note: item.shortDescription ?? "skill updated",
      updatedAt: item.updatedAt,
    })),
  ]
